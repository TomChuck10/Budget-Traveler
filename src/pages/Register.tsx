      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
        ...
        <Card className="border-slate-200 shadow-lg">
          <CardHeader className="text-center pb-2">
            ...
            <CardDescription className="text-base mt-2">Użyj swojego konta Google, aby łatwo stworzyć konto</CardDescription>
          </CardHeader>
          <CardContent className="pt-6">
            <Button 
              onClick={handleGoogleRegister} 
              variant="outline"
              className="w-full bg-white hover:bg-slate-50 text-slate-900 border-slate-200 rounded-xl h-12 text-lg mb-4 flex items-center justify-center gap-3"
            >
